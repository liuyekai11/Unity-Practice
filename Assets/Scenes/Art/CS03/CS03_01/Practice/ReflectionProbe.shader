        ...
        Pass
        {
            ...
            { 
                ...
                * normaldata.y + normal_dir * normaldata.z);
                ...
                half env_hdr_color = DecodeHDR(env_color,unity_SpecCube0_HDR);

                //half4 color_cubmap = texCUBE(_CubeMap,reflect_dir);
                //half3 env_color = DecodeHDR(color_cubmap,_CubeMap_HDR);//确保移动端克以拿到HDR信息
